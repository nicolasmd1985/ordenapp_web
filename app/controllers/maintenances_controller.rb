class MaintenancesController < ApplicationController
  ...
  def create
    params[:maintenance_date] = params[:maintenance][:maintenance_date] + " " + params[:maintenance][:maintenance_time]
  ...
  private
    ...
    def maintenance_params
      params.require(:maintenance).permit(:maintenance_date, :frequency, :out_thing_id)
    end
end
